function[centers_y,centers_x,contri]= find_centers_hough_voting(offset,bin_size,threshold,non_m_win_siz)
 ...
 for y=1:size(offset,1)
  ...
  centers_y=zeros(length(th_centers_y),1);
  centers_x=zeros(length(th_centers_y),1);
