...
opts.imdbPath = fullfile('C:\Users\Bharti\Thesis\data\rgb_object_detection-coco-voc-offset-ssd.mat');
opts.getBatchFunction = @CNN.getCOCOBatch3;
...
opts.train.expDir = 'E:\Bharti\Code\Thesis\data\rgb_object_detection-coco-voc-offset-loaded-L2Loss\' ;


opts.train.batchSize = 16 ;%50;
opts.train.numEpochs = 10000;
%.00001;
opts.train.learningRate = .01;
