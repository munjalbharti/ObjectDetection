...
opts.imdbPath = fullfile('C:\Users\Bharti\Thesis\data\rgb_object_detection-voc-trainval-2012-imdb.mat');
opts.getBatchFunction = @CNN.getFastOffsetBatch;
...
opts.train.expDir = 'E:\Bharti\Code\Thesis\data\rgb_object_detection-voc-trainval-L2AdaptiveLoss\' ;


opts.train.batchSize = 16 ;%50;
opts.train.numEpochs = 10000;
%.00001;
opts.train.learningRate = .00001;
