...
opts.baseDir = 'E:\Bharti\Code\Thesis\voc\VOCtest_06-Nov-2007\VOCdevkit' ; 
opts.data_dir=[opts.baseDir filesep 'VOC2007'];
opts.imgpath=[opts.data_dir filesep 'JPEGImages' ];

opts.resultDir='E:\Bharti\Code\Thesis\data\rgb_object_detection-coco-voc-normalised-L2AdaptiveLoss\Results\VOCval07\51\hough_th_5_bin_5_win_9_with_nmx_conf_avg_time\';
...
for k=1:opts.nclasses
  ...
  det_result_file2=sprintf('%s_det_test_%s.txt','comp4',opts.classes{k});
