function [ap,npos,nd,total_tp,total_fp] = VOCevaldet07(VOCopts,id,cls,draw)
...
for i=1:length(gtids)
    ...
    % read annotation
    rec=PASreadrecord(fullfile(VOCopts.annopath,sprintf('%s.xml',gtids{i})));
...
result_file=sprintf('%s_det_test_%s.txt','comp4',cls);
